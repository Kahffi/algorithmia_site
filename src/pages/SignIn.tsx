...
const SignIn: React.FC = () => {
  return (
    <div className="h-screen flex flex-col bg-cover bg-center" style={{ backgroundImage: "url('path/to/your/background.jpg')" }}>

      {/* Sign In Form */}
      <div className="flex flex-col items-center justify-center flex-grow bg-white bg-opacity-90 shadow-lg rounded-lg p-8">
        {/* Logo */}
        <div className="mb-6">
          <img
            src={logo}
        ...
        <footer className="flex justify-between w-full max-w-sm mt-6 text-xs text-center text-gray-600">
          <a href="https://www.instagram.com/algorithmia.fest/" className="text-pink-500 hover:underline">Instagram: @Algorithmia.fest</a>
          <a href="mailto:algorithmiafest@gmail.com" className="text-blue-500 hover:underline">Email: algorithmiafest@gmail.com</a>
        </footer>
      </div>
    </div>
  );

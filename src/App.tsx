        ...
        <div className="flex flex-col items-center gap-6 p-6 mt-8">
          ...
          <div className="w-full max-w-lg p-4 bg-white rounded-lg border-4 border-purple-500 shadow-lg overflow-hidden transition-transform duration-300 ease-in-out transform hover:scale-105">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-700 mt-2">
                The expedition aims to introduce the Mechatronics and AI program
                to the broader public, especially high school students. It
                showcases the festival as a space for young tech catalysts to
                expand their innovations, inspiring high school students to
                engage and participate in future competitions.
              </p>
              <a
                href="https://www.instagram.com/p/DAsCCNMResP/"
          ...
          <div className="w-full max-w-lg p-4 bg-white rounded-lg border-4 border-blue-300 shadow-lg overflow-hidden transition-transform duration-300 ease-in-out transform hover:scale-105">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-700 mt-2">
                Got some crazy AI ideas swirling in your head? Here's your shot
                to bring them to life! The Competition gathers high school
                students like you to share innovative AI ideas through design
          ...
          <div className="w-full max-w-lg p-4 bg-white rounded-lg border-4 border-pink-300 shadow-lg overflow-hidden transition-transform duration-300 ease-in-out transform hover:scale-105">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-700 mt-2">
                The Exhibition will showcase exciting tech products and projects
                created by MKB students. You’ll get to explore the cutting-edge
                tech that's being developed right now.
              </p>
              <a
